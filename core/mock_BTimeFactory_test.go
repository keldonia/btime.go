...
func (_m *MockBTimeFactory) FindWeekDay(date *time.Time) int {
	ret := _m.Called(date)
...
// MockBTimeFactory_FindWeekDay_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindWeekDay'
type MockBTimeFactory_FindWeekDay_Call struct {
	*mock.Call
}

// FindWeekDay is a helper method to define mock.On call
//   - date *time.Time
func (_e *MockBTimeFactory_Expecter) FindWeekDay(date interface{}) *MockBTimeFactory_FindWeekDay_Call {
	return &MockBTimeFactory_FindWeekDay_Call{Call: _e.mock.On("FindWeekDay", date)}
}

func (_c *MockBTimeFactory_FindWeekDay_Call) Run(run func(date *time.Time)) *MockBTimeFactory_FindWeekDay_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBTimeFactory_FindWeekDay_Call) Return(_a0 int) *MockBTimeFactory_FindWeekDay_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockBTimeFactory_FindWeekDay_Call) RunAndReturn(run func(*time.Time) int) *MockBTimeFactory_FindWeekDay_Call {
	_c.Call.Return(run)
	return _c
}
